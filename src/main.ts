        ...
        <div class="visual-layout">
          ...
          <div class="visual-grid">
            <div class="visual-group">
              ...
              <p class="visual-timing" id="waveform-a-time">Render time: -- ms</p>
              <canvas id="fft-a" width="720" height="120" role="img" aria-label="Group A FFT display"></canvas>
              <p class="visual-timing" id="fft-a-time">Render time: -- ms</p>
            </div>
            <div class="visual-group">
              ...
              <p class="visual-timing" id="waveform-b-time">Render time: -- ms</p>
              <canvas id="fft-b" width="720" height="120" role="img" aria-label="Group B FFT display"></canvas>
              <p class="visual-timing" id="fft-b-time">Render time: -- ms</p>
            </div>
          </div>
        </div>
      </section>
